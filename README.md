...
* Geolocator uses [Google Maps Api](https://developers.google.com/maps/documentation/geocoding){:target="_blank"} so you 'll have to get an API key and fill it in line 7 of the .py file.
